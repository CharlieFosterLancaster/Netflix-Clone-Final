...
//                 onPressed: () async{
//                   await DatabaseManager().increaseView(featuredContent.id);
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(builder: (context) => VideoPlayScreen(
//                         videoUrl: featuredContent.videoUrl,
//                         videoTitle: featuredContent.name,
...
//             child: _videoController.value.initialized ? VideoPlayer(_videoController) : Image.asset(widget.featuredContent.imageUrl, fit: BoxFit.cover,),
//
//           ),
//           AspectRatio(
//             aspectRatio: _videoController.value.initialized ? _videoController.value.aspectRatio : 2.344,
